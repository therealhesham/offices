                  ...
                  >
                    ...
                    <div className="mt-4 flex flex-col space-y-3">
                      <motion.button
                        ...
                        className="w-full flex items-center justify-center bg-indigo-600 cursor-pointer text-white py-2 rounded-lg hover:bg-indigo-700 transition-all duration-300 shadow-sm"
                        aria-label={`${t.preview} for ${item.preview}`}
                      >
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={() => {
                          const url = `/edit-cv/${item.id}`;
                          window.open(url, '_blank');
                        }}
                        className="w-full flex items-center justify-center bg-yellow-500 text-white py-2 rounded-lg cursor-pointer transition-all duration-300 shadow-sm"
